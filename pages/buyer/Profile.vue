            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 py-4">
                ...
                <div v-else-if="userProfile" class="flex items-center gap-4">
                    ...
                    <div class="ml-auto flex items-center gap-4">
                        <ThemeToggle />
                        <button @click="logout" class="text-sm text-brand hover:underline font-semibold">Logout</button>
                     </div>
                </div>
            </div>
        </header>
...
// THE FIX: Import the ThemeToggle component
import ThemeToggle from '~/layouts/children/ThemeToggle.vue';
import { formatAvatarUrl } from '~/utils/formatters'; // Import the formatter
