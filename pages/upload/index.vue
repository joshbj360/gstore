        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between">
          ...
          <div class="flex space-x-2 mt-4 sm:mt-0 shrink-0">
            <button @click="activeTab = 'single'" class="px-4 py-2 text-sm font-medium rounded-md transition-colors" :class="{
              'bg-brand text-white shadow-md': activeTab === 'single',
            ...
            <button @click="activeTab = 'bulk'" class="px-4 py-2 text-sm font-medium rounded-md transition-colors" :class="{
              'bg-brand text-white shadow-md': activeTab === 'bulk',
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div class="space-y-6">
            <h2 class="text-lg font-semibold text-gray-800">
              <span class="text-xs font-bold py-1 px-2 rounded-full bg-brand/10 text-brand-dark mr-2">1</span>
              Upload Media
            </h2>
          ...
          <div class="space-y-6">
             <h2 class="text-lg font-semibold text-gray-800">
              <span class="text-xs font-bold py-1 px-2 rounded-full bg-brand/10 text-brand-dark mr-2">2</span>
              Add Details
            </h2>
            <ProductForm 
