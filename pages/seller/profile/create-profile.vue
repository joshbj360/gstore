    ...
    <div class="w-full max-w-2xl">
      <div class="bg-white shadow-xl rounded-2xl p-6 sm:p-10">
        ...
        <div class="mb-8">
          <div class="relative pt-1">
            <div class="flex mb-2 items-center justify-between">
              <div>
                <span class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-[#f02c56] bg-[#f02c56]/10">
                  Step {{ currentStep }} of 3
                </span>
              </div>
            </div>
            <div class="overflow-hidden h-2 mb-4 text-xs flex rounded bg-[#f02c56]/20">
              <div :style="{ width: `${(currentStep / 3) * 100}%` }" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-[#f02c56] transition-all duration-500"></div>
            </div>
          </div>
        </div>
        ...
        <div v-if="currentStep === 2" class="space-y-8">
          ...
          <div>
            ...
            <div class="flex items-center gap-4">
              ...
              <button type="button" @click="triggerLogoUpload" class="py-2 px-4 bg-[#f02c56]/10 text-[#f02c56] rounded-md hover:bg-[#f02c56]/20 transition-colors text-sm font-semibold">
                Upload Logo
              </button>
        ...
        <div class="mt-10 flex justify-between items-center">
          ...
          <button v-if="currentStep < 3" @click="nextStep" class="py-2 px-6 bg-[#f02c56] text-white rounded-md hover:bg-[#df4949] text-sm font-semibold">
            Next
          </button>
          <button v-if="currentStep === 3" @click="saveProfile" :disabled="isSaving" class="py-2 px-6 bg-[#f02c56] text-white rounded-md hover:bg-[#df4949] text-sm font-semibold disabled:opacity-50">
