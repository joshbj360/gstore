<template>
  ...
  <div class="text-gray-900 dark:text-neutral-100">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
      ...
      <NuxtLink to="/upload" class="flex-shrink-0 px-4 py-2 bg-brand text-white rounded-lg font-semibold hover:bg-brand-dark transition-colors flex items-center justify-center gap-2">
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-neutral-800">
          <tr v-for="product in visibleProducts" :key="product.id" class="hover:bg-gray-50 dark:hover:bg-neutral-800/50">
            ...
            <td class="table-cell text-center">
              <button class="action-button text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/50" title="Edit">
                <Icon name="mdi:pencil-outline" size="18" />
              </button>
              <button class="action-button text-yellow-600 dark:text-yellow-400 hover:bg-yellow-100 dark:hover:bg-yellow-900/50 ml-2" title="Archive">
