    ...
    <div ref="messageContainer" class="flex-1 overflow-y-auto space-y-4 p-4 text-sm">
      ...
      >
        <div 
          ...
          :class="{
            'bg-brand text-white rounded-br-none': message.sender === 'user',
    ...
    <div class="mt-auto p-3 border-t bg-gray-50">
      <form @submit.prevent="sendMessage" class="flex items-start gap-2">
        ...
        <button
          ...
          class="p-2 bg-brand text-white rounded-lg hover:bg-[#df4949] disabled:bg-gray-300 disabled:cursor-not-allowed shrink-0"
        >
